...
void staticScan(Map args) 
{
    ...
    dir('sub') {
        checkmarxASTScanner additionalOptions: "--debug --async --project-tags ${projectTags} --scan-types sast,sca --scan-timeout ${scanTimeout} --sca-resolver ${scaResolverPath} --sca-resolver-params \"--log-level Debug\"",
